...
typedef enum nim_ioctrl_cmd 
{
    ...
    /*!
      ...
      */  
    NIM_IOCTRL_CHECK_LNB_SC_PROT = DEV_IOCTRL_TYPE_LOCK + 10,
    /*!
        Check if the short circuit happened
      */  
    NIM_IOCTRL_LNB_SC_PROT_RESTORE = DEV_IOCTRL_TYPE_LOCK + 11,    
    /*!
      Pull down pin
      */
    NIM_REMOVE_PROTECT = DEV_IOCTRL_TYPE_LOCK + 12,    
    /*!
      Pull up pin
      */
    NIM_ENABLE_CHECK_PROTECT = DEV_IOCTRL_TYPE_LOCK + 13,    
    /*!
      Check sc
      */
    NIM_SC_CHECK = DEV_IOCTRL_TYPE_LOCK + 14,    
     /*!
      Change tuner mode
      */
    NIM_IOCTRL_CHANGE_TN_MODE = DEV_IOCTRL_TYPE_LOCK + 15,   

    
    /*!
        Get global lock status
      */
    NIM_IOCTRL_CHECK_LOCK = DEV_IOCTRL_TYPE_UNLOCK + 0,
    /*!
    ...
    */  
    ...
    /*!
      ...
      */
      NIM_IOCTRL_GET_CHANNEL_INFO = DEV_IOCTRL_TYPE_UNLOCK + 10,
     /*!
      set tuner bandwidth;
      */
      NIM_IOCTRL_SET_TUNER_BANDWIDTH = DEV_IOCTRL_TYPE_UNLOCK + 11,
} nim_ioctrl_cmd_t;
...
typedef struct nim_config 
{
  ...
  /*!
    ...
    */
    ...
    /*!
      If you need clock out from tuner clkout pin to other chip use, 
      */    
    ...
    u8 demod_band_width;
    /*!
      The notify task priority
      */
    u32 task_prio;
    /*!
      The notify task statck size
      */  
    u32 stack_size;
    /*!
      Tuner loopthrough

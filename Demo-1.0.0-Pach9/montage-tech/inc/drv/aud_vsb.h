...
/*!
   ...
   */
RET_CODE aud_file_pushesbuffer_vsb(void *p_dev, u32 src_addr, u32 size);
...
/*!
  Get info from kernel to send to PC for chimera auto testing.
  */
RET_CODE aud_chimera_get_info_vsb(void *p_dev, u32 *p_param);

/*!
  Tell audio check module if auto test is turned on or off.
  */
RET_CODE aud_set_chimera_mode_vsb(void *p_dev, u32 mode);

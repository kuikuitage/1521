...
/*!
  ...
  */
#define ATTACH_DRIVER(module, chip, chip_version, board)  \
    module##_NXP(module, chip, chip_version, board)
#else
/*!
  comment
  */
...
/*!
  usb2 device
  */
#define DEV_NAME_BLOCK_USB2 "usb2"
/*!
memory card
  */
...
/*!
  comment
  */
#define UIO_WARRIORS(module, chip, chip_version, board)  \
...
/*!
  comment
  */
#define UIO_NXP(module, chip, chip_version, board)  \
    uio_attach(#board)
...
/*!
   ...
   \param[in] name
  */
static inline RET_CODE uio_attach_warriors(char *name) 
{
    return uio_warriors_attach(name);
}
...
/*!
  comment
  */
#define PTI_NXP(module, chip, chip_version, board)  \
    pti_attach##_##chip(#module"_"#chip)
...
/*!
  OSD driver attachment for nxp board
  */
#define OSD_NXP(module, chip, chip_version, board)  \
    osd_attach##_##chip(#module"_"#chip)
...
/*!
  comment
  */
#define GPE_4BIT_NXP(module, chip, chip_version, board)  \
    gpe_4bit_attach(#module"_"#chip)
...
/*!
  comment
  */
#define GPE_8BIT_NXP(module, chip, chip_version, board)  \
    gpe_8bit_attach(#module"_"#chip)
/*!
   Attach the drivers to magic disp device
...
/*!
  Audio driver attachment for nxp board
  */
#define AUDIO_NXP(module, chip, chip_version, board)  \
    audio_attach##_##chip(#module"_"#chip)
...
/*!
  Video driver attachment for nxp board
  */
#define VIDEO_NXP(module, chip, chip_version, board)  \
    video_attach##_##chip(#module"_"#chip)
...
/*!
  ...
  */
#define AVSYNC_NXP(module, chip, chip_version, board)  \
    avsync_sim_attach##_##chip(#module"_"#chip)
/*!
  Av sync driver attachment for simulator
  */
...
/*!
  comment
  */
#define I2C_NXP(module, chip, chip_version, board)  \
    i2c_attach##_##chip(#module"_"#chip)
#endif
...
/*!
  comment
  */
#define CHARSTO_NXP(module, chip, chip_version, board)  \
    charsto_attach##_##chip(#module"_"#chip)
...
/*!
   ...
   \param[in] name
  */
static inline RET_CODE nim_sim_attach_nxp(char *name)
    {return nim_win32_attach(name);}
/*!
   TODO: fix me!
...
/*!
  comment
  */
#define NIM_NXP(module, chip, chip_version, board)  \
    nim_attach##_##chip(#module"_"#chip)

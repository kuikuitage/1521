...
/*!
  Information structure for initialize gdi
  */
typedef struct
{
  /*!
...
/*!
  ...
  \return : TRUE for success, otherwise failed.
  */
BOOL gdi_init(gdi_config_t *p_info);
...
/*!
  ...
  \return : TRUE for success, otherwise failed.
  */
BOOL gdi_init_v2(gdi_config_t *p_info);
...
/*!
  ...
  \param[in] format : screen format.
  \param[in] pal : palette.
  \param[in] rc : screen rectangle.
  \param[in] cdef : default color.
  \param[in] ckey : color key.
  \return : TRUE for success, otherwise failed.
  */
BOOL gdi_reset_screen(u8 format, palette_t *p_pal,
  rect_t *p_rc, u32 cdef, u32 ckey);
...
/*!
  ...
  */
hdc_t gdi_get_dc(rect_t *p_src, rect_t *p_vrc,
...
/*!
  ...
  \param[out] p_colorkey : for get colorkey.

  \return : True for success, otherwise false.
  */
BOOL gdi_get_colorkey(u32 *p_colorkey);

/*!
  Sets the color key value.

  \param[in] colorkey : colorkey for set.
  \return : True for success, otherwise false.
  */
BOOL gdi_set_colorkey(u32 colorkey);
...
/*!
  ...
  \param[in] hsdc : Handle to the source device context.
  \param[in] sx : Specifies the x-coordinate, in logical units, of the upper-left corner of the source rectangle.
  \param[in] sy : Specifies the y-coordinate, in logical units, of the upper-left corner of the source  rectangle.
  \param[in] sw : Specifies the width, in logical units, of the source rectangle.
  \param[in] sh : Specifies the width, in logical units, of the source rectangle.
  \param[in] hddc : Handle to the destination device context.
  \param[in] dx : Specifies the x-coordinate, in logical units, of the upper-left corner of the destination rectangle.
  \param[in] dy : Specifies the y-coordinate, in logical units, of the upper-left corner of the destination rectangle.
  \param[in] dw : Specifies the width, in logical units, of the destination rectangle.
  \param[in] dh : Specifies the height, in logical units, of the destination rectangle.
  \param[in] rop : Specifies the raster operation to be performed.
  \return : NULL
  */
void gdi_stretch_blt(hdc_t hsdc, u16 sx, u16 sy, u16 sw, u16 sh, hdc_t hddc,
  u16 dx, u16 dy, u16 dw, u16 dh, u32 rop);

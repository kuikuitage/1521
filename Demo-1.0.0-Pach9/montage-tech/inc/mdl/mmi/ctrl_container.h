...
/*!
   Class name of container control class.
  */
#define CTRL_CONT    ("container")


/*!
   Thist structure defines private data of container control,
   mainly about clip region information of container
  */
typedef struct
{
  /*!

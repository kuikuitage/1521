...
/*!
   Font in array type
  */
#define RSC_FONT_TYPE_ARRAY     0
/*!
   Font in vector type
  */
#define RSC_FONT_TYPE_VECTOR    1
/*!
   Font in fixed width
  */
#define RSC_FONT_MONOSPACED     0x80
...
{
  /*!
     Common font buffer id.
    */
  FONT_BUFFER_COMMON = 0,
  /*!
     Local font buffer id.
    */
  FONT_BUFFER_LOCAL
}font_buf_type_t;

/*!
   Return TRUE when charcode exist in font lib
  */
typedef BOOL (*check_char_code_t)(u16 font_lib_id, u16 char_code);

/*!
   Font style map stucture
  */
typedef struct
{
  /*!
  ...
  /*!
     Font buffer id
    */
  font_buf_type_t font_buf_type;
  /*!
     Fnterval between characters.
    */
  u8 interval;
  /*!
     Callback for check charcode, NULL means use min and max code bound.
    */
  check_char_code_t check;
}font_map_t;
...
typedef struct
{
  ...
  u16 pal_buf_size;
  /*!
     Max common font size
    */
  u32 comm_font_buf_size;
  /*!
     Max local font size
    */
  u32 local_font_buf_size;
  /*!
...
/*!
   ...
   \param[in] char_code : unicode
   \param[in] p_hdr_font : font head
   \param[out] p_data : data address.
   
   \return : font resource
  */
BOOL rsc_get_font_by_char(handle_t rsc_handle,rsc_fstyle_t *p_fstyle,
  u16 char_code, rsc_font_t *p_hdr_font, u8 **p_data);
...
/*!
   ...
   \return : interval between chars in horizon direction
  */
...
/*!
   ...
   \param[in] p_style : new rect style
   \return : rect style index
  */
u16 rsc_register_rstyle(rsc_rstyle_t *p_style);

/*!
   Add new font style

   \param[in] p_style : new font style
   \return : font style index
  */
u8 rsc_register_fstyle(rsc_fstyle_t *p_style);

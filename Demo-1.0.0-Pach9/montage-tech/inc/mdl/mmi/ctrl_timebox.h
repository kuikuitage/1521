...
/*!
   Class name of timebox control class
  */
#define CTRL_TBOX              ("timebox")
...
/*!
  ...
  */
#define TBOX_ITEM_YEAR              0
/*!
   Identify for month item bit.
  */
#define TBOX_ITEM_MONTH             1
/*!
   Identify for day item bit.
  */
#define TBOX_ITEM_DAY               2
/*!
   Identify for hour item bit.
  */
#define TBOX_ITEM_HOUR              3
/*!
   Identify for minute item bit.
  */
#define TBOX_ITEM_MIN               4
/*!
   Identify for second item bit.
  */
#define TBOX_ITEM_SECOND            5
...
/*!
   This structure defines private data of timebox
  */
typedef struct
{
  /*!

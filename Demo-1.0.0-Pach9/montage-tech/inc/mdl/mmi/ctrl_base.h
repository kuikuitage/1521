...
typedef struct control
{
  ...
  u32 priv_attr;
  /*!
     Control private memory address.
    */
  u32 priv_data;
  /*!
...
typedef struct control_class
{
  ...
  /*!
     Next control class
    */
  struct control_class *p_next;
  /*!
     Debug information
    */
#ifdef CTRL_DEBUG
  /*!
     Record current contorl count
    */
  u32 curn_cnt;
  /*!
     Record maximal control count
    */
  u32 max_cnt;
#endif    
}control_class_t;
...
typedef struct
{
  /*!
    ...
    */
  control_class_t *p_class_table[CLASS_NAME_TABLE_SIZE];
  /*!
     Class heap
    */
...
/*!
   Class name error.
  */
#define ERR_CTRL_CLASS_NAME        ((s32) - 0x100)
/*!
   Class length error
  */
#define ERR_CTRL_CLASS_LENGTH      ((s32) - 0x101)
...
enum
{
  ...
  /*!
   Msg arabic unicode
  */
  MSG_ARA_UNI = MSG_SHIFT_DEFAULT_BEGIN + 0x0200
};
...
/*!
  ...
  \param[in] p_classname : class name
  \param[in] p_info : register info
  \return : SUCCESS or ERR_FAILURE.
  */
RET_CODE ctrl_register_ctrl_class(u8 *p_classname,
                                  control_class_register_info_t *p_info);

/*!
  Delete control class.

  \param[in] p_class_name : control class name.
...
/*!
   ...
   \return : NULL
  */
void ctrl_set_attr(control_t *p_ctrl, u8 attribut);

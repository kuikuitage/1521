...
/*!
   ...
   \return If successful return TRUE, Otherwise return FALSE.
  */
BOOL fw_register_ap_msghost(u16 ap_id, u8 root_id);
...
/*!
   ...
   \return If successful return TRUE, Otherwise return FALSE.
  */
BOOL fw_unregister_ap_msghost(u16 ap_id, u8 root_id);
...
/*!
  ...
  */
void fw_default_mainwin_loop(u8 root_id);
...
/*!
  ...
  */
RET_CODE fw_notify_parent(u8 root_id,
                          u8 type,
                          BOOL is_sync,
                          u16 content,
                          u32 para1,
...
/*!
   ...
   \return If successful return SUCCESS, Otherwise return ERR_FAILTURE.
  */
RET_CODE fw_notify_child(u8 root_id,
                         u8 child_id,
                         u8 type,
                         BOOL is_sync,
                         u16 content,

...
typedef struct tag_ifilter
{
  ...
  /*!
    notify evt out.
    This interface is protected. it can be call by itself and it's child pin.
    */
  RET_CODE (*notify)(handle_t _this, void *p_evt);
  ...
  /*!
    ...
    */
  VIRTUAL RET_CODE (*on_complete_connect)(handle_t _this, ipin_t *p_pin);

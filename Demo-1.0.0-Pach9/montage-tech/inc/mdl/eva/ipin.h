...
typedef struct tag_ipin
{
  ...
  /*!
    check media format is received. Pure Virtual.
    */
  ...
  /*!
    ...
    */
  RET_CODE (*set_media_format)(handle_t _this, media_format_t *p_format);
  
  /*!
    Retrieves the pin's media format. 
    */
  media_format_t *(*get_media_format)(handle_t _this);
  ...
  /*!
    The send_message_out method send a message to user as async mode.
    */
  ...
  /*!
    Retrieves the media format enum by supported. Pure virtual.
    */
  PURE VIRTUAL list_media_format_t *(*list_media_format)(handle_t _this);

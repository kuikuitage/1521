...
typedef enum
{
	...
	// 7-9 hight for user
	HIGHT_PRIORITY_START				= 7,
	HIGHT_PRIORITY_END					= 9,

	AP_FRM_TASK_PRIORITY 				= 10,
	UI_FRM_TASK_PRIORITY				= 11,
	AP_ADS_TASK_PRIORITY 				= 12,
	DRV_SMC_TASK_PRIORITY				= 13,
	
	//14---18 hight  ca task,
	HIGHT_PRIORITY_CA_START				= 14,
	HIGHT_PRIORITY_CA_END				= 18,
	...
	//33---48 low prio tf ca task
	DRV_CAS_MODUL_TASK_PRIORITY_START 	= 33,
	DRV_CAS_MODUL_TASK_PRIORITY_END 	= 48,
	  
	PICTURE_CHAIN_1_PRIORITY 			= 49,
	PICTURE_CHAIN_2_PRIORITY 			= 50,
	MDL_VBI_TASK_PRIORITY 				= 51,
	MDL_DVB_TASK_PRIORITY				= 52,
	MDL_NIM_CTRL_TASK_PRIORITY			= 53,
	MDL_MONITOR_TASK_PRIORITY 			= 54, // don't change it
	MDL_DM_MONITOR_TASK_PRIORITY		= 55,
	CUSTOMER_TASK_PRIORITY 				= 56, // don't change it
	
	//57--60 reserver  for ad
	AD_TASK_PRIO_START					= 57,
	AD_TASK_PRIO_END 					= 60,
	
	AP_OTA_MON_TASK_PRIORITY			= 61,  

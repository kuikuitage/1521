...
the cas max entitle len
  */
#define CAS_MAX_PRODUCT_ENTITLE_NUM (1000)
/*!
the cas max ipp len
  */
...
/*!
  ...
  */
#define CAS_MAX_MSG_DATA_LEN  (1024)
/*!
...
*/
   CAS_E_YJ_OVERDUE,
/*!
    DIVI: INIT INSTALL AND CARD NOT USE
    */
  CAS_E_CARD_INIT_INSTALL,
/*!
    DIVI: INSTALL ING AND CARD NOT USE
    */
  CAS_E_CARD_INSTALLING,
/*!
    DIVI: CARD  NEED REPAIR AND STOP USE
    */
  CAS_E_CARD_REPAIR,
/*!
    DIVI: CARD  NEED TO STOP
    */
  CAS_E_CARD_STOP,
/*!
    DIVI: CARD  SATUS IS LOGOUT
    */  
  CAS_E_CARD_LOGOUT,
 /*!
    DIVI: PROG LEVEL less than parental control
    */  
  CAS_E_PROG_LEVEL_LOWER,
 /*!
    DIVI: child card can be temporary activated
    */   
  CAS_E_CADR_TEMP_ACT,
 /*!
    DIVI: child card can be temporary activated
 ...
 /*!
    DIVI: child and mother card not pair
    */ 
  CAS_S_MOTHER_SON_CARD_NOT_PAIR,
/*!
    DIVI: mother card Communication failure
    */ 
...
/*!
  DIVI: card not during active time
  */  
  CAS_S_CARD_NOT_IN_ACTTIME,
/*!
  DIVI: active success and insert next card
  */  
  CAS_S_CARD_INSERT_NEXT_CARD,
/*!
  DIVI: stop card active
  */   
  CAS_S_CARD_STOP_ACTIVE,
  /*!
    请插入母卡认证
*/
   CAS_E_LX_INSERT_PARENTCARD,
/*!
    子卡认证失败
*/
   CAS_E_LX_CHILDCARD_AUTHE_FAIL,
/*!
    子卡认证成功
*/
   CAS_E_LX_CHILDCARD_AUTHE_SUCCE,
/*!
    请插入认证子卡
*/
   CAS_E_LX_CHILDCARD_INSERT,
/*!
    子卡取消成功
*/
   CAS_E_LX_CHILDCARD_CANCELOK,
/*!
    子卡设置成功
*/
   CAS_E_LX_CHILDCARD_SETUPOK,
/*!
    母卡确认失败
*/
   CAS_E_LX_PARENT_CONFIRM_FAIL,
/*!
    母卡确认成功
*/
   CAS_E_LX_PARENT_CONFIRM_SUCCE,
/*!
    end,
    */
  CAS_EVT_ALL
...
/*!
  ...
  RET_CODE (*nvram_write)(u32 offset,
              u8 *p_buf, u32 size);
/*!
    The callback of nvram erasing function
    */
  RET_CODE (*nvram_erase)(u32 offset,
              u8 *p_buf, u32 size);
/*!
...
*/
  u8 transparency;
/*!
  sumavision: display type of osd, it can exit by key or not
*/
  u8 display_status;
}msg_info_t;
...
ONLY1CA:position
*/
  FingerCoodinate_t position[CAS_MAXNUM_FINGER_POSITION];
...
/*!
  ...
  \return Return 0 for success and others for failure.
  */
RET_CODE cas_shida_attach(cas_module_cfg_t *p_cfg, u32 *p_cam_id);

...
the cas max entitle len
  */
#define CAS_MAX_PRODUCT_ENTITLE_NUM (320)
/*!
the cas max ipp len
  */
...
/*!
  ...
  */
#define CAS_MAX_MSG_DATA_LEN  (4096)
/*!
...
DVBCA operator info
*/
  ST_DVBCA_OPERATORINFO dvbca_operator_info[CAS_MAX_OPERTOR_NUM];
...
/*!
 product entitle info
 */
product_entitle_info_t  p_entitle_info[DVBCA_MAXLEN_ENTITL];
/*!

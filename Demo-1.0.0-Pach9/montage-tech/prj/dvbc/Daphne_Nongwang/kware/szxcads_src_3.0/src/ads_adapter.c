...
ads_module_priv_t *p_ads_priv = NULL;
...
void ads_send_event(u32 adm_id, u32 event, u32 param)
{
  ...
  if(g_ads_priv.notify.evt_cb != NULL)
  {
	...
	DEBUG(TRAD, INFO, "cas_notify_callback start\n");
...
RET_CODE ads_init(u32 adm_id, ads_module_cfg_t *p_param)
{
...
RET_CODE ads_display(u32 adm_id, ads_module_cfg_t *p_param)
{
  return g_ads_priv.adm_op[adm_id].func.display(p_param);
}

RET_CODE ads_hide(u32 adm_id, ads_module_cfg_t *p_param)
{

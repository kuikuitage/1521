...
/*!    
  ...
  */ 
  ...
  open logo szxc_ad
  */
  ADS_IOCMD_AD_OPEN_LOGO,
  /*!
  close logo szxc_ad
  */
  ADS_IOCMD_AD_CLOSE_LOGO,
  ADS_IOCMD_AD_MES_PIC,
  ADS_IOCMD_AD_HOME_PIC,
  ADS_IOCMD_AD_VOLUM_PIC,
  ADS_IOCMD_AD_BROAD_PIC,
  ADS_IOCMD_AD_EPG_PIC,
  ADS_IOCMD_AD_CHANNEL_PIC,
  ADS_IOCMD_AD_CLEAR_FLAG,
...
/*!    
    The callback of get adv screen_status
    */
 RET_CODE (*get_screen_statu)(u8 adv_stype);
}ads_module_cfg_t;

...
control_t *conditional_accept_menu_info(control_t * p_ca_frm, u16 y )
{
  ...
  u16 stxt_btn[3] =
  { 
    IDS_SMARTCARD_INFO, IDS_CARD_MANAGE, IDS_CA_CHARA_CODE,
  };   
...
void on_ca_frm_btn_select_number(u8 ctrlID, u32 para1 )
{
  ...
  switch(ctrlID)
  {
    case IDC_BTN_CA_INFO:
      ...
      break;
    case IDC_BTN_CA_MANAGE:
      manage_open_menu(ROOT_ID_CA_MOTHER, (u32)para1, 0);
      break;
    case IDC_BTN_CA_CHARACTER_CODE:
      manage_open_menu(ROOT_ID_CHARACTER_CODE, (u32)para1, 0);
      break;
    default:
      break;
    }

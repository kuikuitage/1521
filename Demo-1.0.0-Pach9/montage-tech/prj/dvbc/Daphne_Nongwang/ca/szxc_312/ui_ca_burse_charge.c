...
RET_CODE open_ca_burse_dlg(u32 para1, u32 para2)
{
  ...
  ctrl_set_rstyle(p_cont, RSI_SN_SET_BUTTON_SELECT, RSI_SN_SET_BUTTON_SELECT, RSI_SN_SET_BUTTON_SELECT);
  ...
  ctrl_set_rstyle(p_title, RSI_SN_BG_TITLE, RSI_SN_BG_TITLE, RSI_SN_BG_TITLE);
  ...
  p_content = ctrl_create_ctrl((u8 *)CTRL_TEXT, IDC_CONTENT,
                       ...
                       p_cont, 0);
  ctrl_set_rstyle(p_content, RSI_SN_SET_BUTTON_SELECT, RSI_SN_SET_BUTTON_SELECT, RSI_SN_SET_BUTTON_SELECT);
  ...
  p_icon = ctrl_create_ctrl((u8 *)CTRL_BMAP, IDC_ICON,
                   ...
                   40, 40,
                   p_cont, 0);
  bmap_set_content_by_id(p_icon, IM_SN_ICON_SYSINFO);

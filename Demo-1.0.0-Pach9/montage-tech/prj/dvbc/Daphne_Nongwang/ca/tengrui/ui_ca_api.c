...
void ui_init_ca(void)
{
  ...
  fw_register_ap_msghost(APP_CA, ROOT_ID_CA_IPP);
  fw_register_ap_msghost(APP_CA, ROOT_ID_PROVIDER_INFO);
  fw_register_ap_msghost(APP_CA, ROOT_ID_AUTO_FEED);
  fw_register_ap_msghost(APP_CA, ROOT_ID_CA_PROMPT);
  fw_register_ap_msghost(APP_CA, ROOT_ID_ALERT_MESS);
  #endif
...
void ui_release_ca(void)
{
  ...
  #endif
  #if(CONFIG_CAS_ID == CONFIG_CAS_ID_TR)
  fw_unregister_ap_msghost(APP_CA, ROOT_ID_CA_IPP);
  fw_unregister_ap_msghost(APP_CA, ROOT_ID_PROVIDER_INFO);
  fw_unregister_ap_msghost(APP_CA, ROOT_ID_AUTO_FEED);
  fw_unregister_ap_msghost(APP_CA, ROOT_ID_CA_PROMPT);
  fw_unregister_ap_msghost(APP_CA, ROOT_ID_ALERT_MESS);
  #endif

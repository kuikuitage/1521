...
#define CONDITIONAL_ACCEPT_LEVEL_LEVEL_CONTROL_ITEM_V_GAP    4
...
#define CONDITIONAL_ACCEPT_LEVEL_CHANGE_RESULT_Y        200
...
/* others */
#define CONDITIONAL_ACCEPT_WATCH_LEVEL_TOTAL 18

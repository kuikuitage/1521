...
#define IPP_RTIME_IPP_CONT_Y			(COMM_ROOT_Y + 80)
#define IPP_RTIME_IPP_CONT_W			(COMM_ROOT_W)
#define IPP_RTIME_IPP_CONT_H			410

/* coordinate */
#define IPP_RTIME_IPP_X			0
#define IPP_RTIME_IPP_Y			0
#define IPP_RTIME_IPP_W			(COMM_ROOT_W)
...
#define IPP_RTIME_ITM_W 240
#define IPP_RTIME_ITM_H 35

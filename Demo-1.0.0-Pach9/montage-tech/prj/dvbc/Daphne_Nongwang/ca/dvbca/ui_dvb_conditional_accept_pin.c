...
RET_CODE open_dvbcas_accept_pin(u32 para1, u32 para2)
{
...
static RET_CODE on_conditional_accept_pin_ca_modify(control_t *p_ctrl, u16 msg, u32 para1, u32 para2)
{
  ...
  {
	pin_data_t.text_strID = IDS_CA_INVALID_CARD;
  }
  else if(para1 == CAS_ERR_NOCARD)
  {
	pin_data_t.text_strID = IDS_CA_NO_CARD;
  }
  else if(para1 == CAS_ERR_INVALID_ECMPID)
  {
	pin_data_t.text_strID = IDS_CAS_E_ECM_ERROR;
  }
  else if(para1 == CAS_ERR_INVALID_EMMPID) 
  {
    pin_data_t.text_strID = IDS_CAS_E_EMM_ERROR;
  }
  else if(para1 == CAS_ERR_NOENTITLE)
  {
	pin_data_t.text_strID = IDS_NO_ENTITLEMENT;
  }
  else if(para1 == CAS_ERR_STB_PAIR_FAILED)
  {
	pin_data_t.text_strID = IDS_CA_PAIR_FAILED;
  }
  else if(para1 == CAS_FAILED)
  {
	pin_data_t.text_strID = IDS_CA_CAS_FAILED;
  }
  else if(para1 == CAS_ERR_INIT_ERROR)
  {
	pin_data_t.text_strID = IDS_CA_INIT_ERR;
  }
  else if(para1 == CAS_ERR_CARD_VER_ERROR)
  {
	pin_data_t.text_strID = IDS_CA_CARD_VER_ERR;
  }
  else
  {
	pin_data_t.text_strID = IDS_INPUT_PASSWORD_ERROR;

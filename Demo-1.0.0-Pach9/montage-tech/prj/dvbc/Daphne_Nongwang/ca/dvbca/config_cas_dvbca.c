...
#if 0
static RET_CODE nvram_erase(u32 offset, u8 *p_buf, u32 size)
{
...
void on_cas_init(void)
{
...
#ifndef WIN32
  DEBUG(DVBCAS_PORTING,INFO,"[dvbcas] %s %d ERR! \n",__func__,__LINE__);
  ...
  cas_module_cfg.task_prio = DRV_CAS_MODUL_TASK_PRIORITY_START+1;

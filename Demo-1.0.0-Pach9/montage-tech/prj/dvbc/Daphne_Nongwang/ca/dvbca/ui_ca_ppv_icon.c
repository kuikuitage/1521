...
RET_CODE open_ca_ppv_icon(u32 para1, u32 para2)
{
  ...
  ctrl_set_rstyle(p_cont, RSI_SN_BAR_BLUE_NORMAL, RSI_SN_BAR_BLUE_NORMAL, RSI_SN_BAR_BLUE_NORMAL);//RSI_PPV_ICON_TXT
  if (p_cont == NULL)
  {
    return FALSE;
  }
  p_ctrl = ctrl_create_ctrl((u8 *) CTRL_TEXT, IDC_PPV_ICON_CONT1, 

...
RET_CODE ui_desktop_proc(control_t *p_ctrl, u16 msg,
                             u32 para1, u32 para2);

static RET_CODE on_open_menu(control_t *p_ctrl, u16 msg,
                               u32 para1, u32 para2)
{
...
static RET_CODE on_ota_upgrade_upgrade(

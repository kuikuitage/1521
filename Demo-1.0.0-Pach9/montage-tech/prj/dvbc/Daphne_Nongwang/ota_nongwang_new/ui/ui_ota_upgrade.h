...
#define OTA_UPGRADE_TTLX 144
#define OTA_UPGRADE_TTLY 178
#define OTA_UPGRADE_TTLW (OTA_UPGRADE_CONTW - 2 * OTA_UPGRADE_TTLX)
#define OTA_UPGRADE_TTLH 32

#define OTA_UPGRADE_TDI_X 0
#define OTA_UPGRADE_TDI_Y (OTA_UPGRADE_TTLY-50)
#define OTA_UPGRADE_TDI_W (SCREEN_WIDTH - OTA_UPGRADE_TTLX)
#define OTA_UPGRADE_TDI_H 32

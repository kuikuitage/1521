...
/******************************************************************************/
#ifndef __AP_KINGVON_OTA_H_
#define __AP_KINGVON_OTA_H_
...
/*!
  default locking parameters
  */
#define OTA_DEFAULT_PID_1 (0x1b58)

#ifdef ZHONGMOU_AREA
#define OTA_DEFAULT_FREQ_1 (427000)
#else
#define OTA_DEFAULT_FREQ_1 (267000)
#endif
#define OTA_DEFAULT_SYM_1 (6875)

#define OTA_DEFAULT_PID_2 (0x1b58)
#define OTA_DEFAULT_FREQ_2 (307000)
#define OTA_DEFAULT_SYM_2 (6875)
...
typedef enum
{
  ...
  /*!
    OTA 
    */
  OTA_SM_LOCKING_DEFAULT_1,
  /*!
    OTA 
    */    
  OTA_SM_LOCKING_DEFAULT_2,  
  /*!
    OTA wait lock.
    */
  OTA_SM_WAIT_LOCK,
  /*!
    OTA
   */
  OTA_SM_WAIT_LOCK_DEFAULT_1,
  /*!
    OTA
   */
  OTA_SM_WAIT_LOCK_DEFAULT_2,  
  /*!
    OTA user input.
    */
  OTA_SM_USER_INPUT,
  ...
  /*!
    OTA searching.
    */
  OTA_SM_SEARCHING_DEFAULT_1,
  /*!
    OTA searching.
    */
  OTA_SM_SEARCHING_DEFAULT_2,
  /*!
    OTA wait DSI.
    */
  OTA_SM_WAIT_DSI,  
  /*!
    OTA
   */
  OTA_SM_WAIT_DSI_DEFAULT_1,
  /*!
    OTA
   */
  OTA_SM_WAIT_DSI_DEFAULT_2,  
  /*!
    OTA wait DII.
    */
  OTA_SM_WAIT_DII,

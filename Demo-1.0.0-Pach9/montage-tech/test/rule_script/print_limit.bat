...
findstr /R /v "^config ^test mtos_printk.c mtos_printk.h ap_init.c log_def.h ucos_msg.c" all_changed_files.txt>changed_files.txt
del all_changed_files.txt
findstr /P /N /C:"OS_PRINTK" /F:changed_files.txt >test\changed_files.txt
findstr /v /C:"//OS_PRINTK" test\changed_files.txt >test\changed_files1.txt
findstr . test\changed_files1.txt
if not %errorlevel%==0 goto end
@REM -->

@REM <-- Return result
echo "OS_PRINTK NOT ALLOWED!!!!!!!!!!!!!!!!">test\out.txt
type test\changed_files1.txt>>test\out.txt

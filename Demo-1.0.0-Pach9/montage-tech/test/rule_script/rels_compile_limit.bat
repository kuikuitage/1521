...
findstr "test/common_script/ config_prj/other/common/ test/rule_script/ test/global_symbol_check" changed_files.txt >> limit.txt
findstr "board_config.xls board_config.bin" changed_files.txt >> limit.txt
:findstr "release_" changed_files.txt >> limit.txt
@REM -->

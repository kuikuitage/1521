...
static RET_CODE _dispatch_tmr(u32 dest, u16 content, u32 para1, u32 para2)
{
  ...
  p_win = fw_find_mainwin_by_id((u8)dest);
  if(p_win == NULL)
  {
...
static BOOL _add_msghost(ap_evt_entry_t *p_entry, u8 host)
{
...
static BOOL _del_msghost(ap_evt_entry_t *p_entry, u8 host)
{
...
BOOL fw_get_msg(u8 root_id, fw_msg_t *p_msg)
{
  os_msg_t *p_head = &p_msg->head;
  fw_main_t *p_info = NULL;

/******************************************************************************/
/******************************************************************************/
#ifndef __GPE_4BPP_H__
#define __GPE_4BPP_H__
...
/*!
  ...
  */
RET_CODE gpe_soft_draw_pixel_4bpp(struct hld_gpe *p_gpe,
                                            region_t *p_region,
                                            pos_t *p_pos,
                                            u32 c);
...
/*!
  ...
  \param[in] c Specifies the color.
  */
RET_CODE gpe_soft_draw_h_line_4bpp(struct hld_gpe *p_gpe,
                                            region_t *p_region,
                                            pos_t *p_pos,
                                            u32 w,
                                            u32 c);
...
/*!
  ...
  \param[in] c Specifies the color.
  */
RET_CODE gpe_soft_draw_v_line_4bpp(struct hld_gpe *p_gpe,
                                            region_t *p_region,
                                            pos_t *p_pos,
                                            u32 h,
                                            u32 c);
...
/*!
  ...
  \param[in] c Specifies the color.
  */
RET_CODE gpe_soft_draw_rectangle_4bpp(struct hld_gpe *p_gpe,
                                            region_t *p_region,
                                            rect_vsb_t *p_rect,
                                            u32 c);
...
/*!
  ...
  */
RET_CODE gpe_soft_draw_image_4bpp(struct hld_gpe *p_gpe,
                                        region_t *p_region,
                                        rect_vsb_t *p_rect,
                                        void *p_buf,
                                        void *p_palette,
...
/*!
  ...
  */
RET_CODE gpe_soft_dump_image_4bpp(struct hld_gpe *p_gpe,
                                        region_t *p_region,
                                        rect_vsb_t *p_rect,
                                        void *p_buf,
                                        void *p_palette,
...
/*!
  ...
  */
RET_CODE gpe_soft_bitblt_4bpp(struct hld_gpe *p_gpe,
                                    region_t *p_dst,
                                    rect_vsb_t *p_dst_rc,
                                    region_t *p_ref,
                                    rect_vsb_t *p_ref_rc,

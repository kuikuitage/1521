/******************************************************************************/
/*            Shanghai Montage Microelectronic Inc.                           */
/******************************************************************************/
/*     Version:		1.00.20                                                   */
/*********************Supported Tuner List*************************************/
/*  Vendor  Name    Model   Version Date    Time    Author      Comments      */
/*  Montage TC2800  -       1.00.20 130724  18:00   YZ.Huang    Update        */
...
/*  LG		TDCC    G0X1F   1.00.05 120503  17:00   YZ.Huang    Create        */
/*  LG		TDCC    G1X1F   1.00.14 121227  15:00   YZ.Huang    Create        */
/*  All     Default Tuner   1.00.04 120427  10:00   YZ.Huang    Create        */
/******************************************************************************/
...
{
	*version_no = 10020;		// for Can tuner, use version number of this file
	*version_time = 13072418;	// for Can tuner, use version time of this file
...
MT_FE_RET mt_fe_dc2800_tn_init_tc2800(void *dev_handle)
{
	...
	handle->tuner_settings.tuner_handle = (U32)&tc2800_config;
	mt_fe_tn_init_tc2800(handle);

	tc2800_config.tuner_dev_addr = handle->tuner_settings.tuner_dev_addr;

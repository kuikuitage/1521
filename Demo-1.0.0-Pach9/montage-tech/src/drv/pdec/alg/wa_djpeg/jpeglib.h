...
#define REG32(port)         (*((volatile int*)(port)))
...
#define j_ap_pipe_id  0x4001
#define j_av_pipe_id  0x8765


extern int warriors_printf_mem(const char *p_fmt, ...);
//#define IPC_DEBUG_ENABLE
#define IPC_PRINTF warriors_printf_mem
...
struct jpeg_compress_struct {
  ...
  u8 input_gamma;		/* image gamma of input image */
...
struct jpeg_decompress_struct {
  ...
  u8 output_gamma;		/* image gamma wanted in output */
...
EXTERN(void) jpeg_CreateDecompress JPP((j_decompress_ptr cinfo, unsigned int structsize));
...
EXTERN(void) jpeg_stdio_src JPP((j_decompress_ptr cinfo, u8 * infile, u32 size));
...
extern BOOL jpeg_resync_to_restart JPP((j_decompress_ptr cinfo, int desired));
